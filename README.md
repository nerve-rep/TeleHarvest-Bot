...
2. Заполните его следующими переменными:
   ```
   API_ID=ваш_api_id
   API_HASH=ваш_api_hash
   BOT_TOKEN=токен_вашего_бота
   ```
3. Получите `API_ID` и `API_HASH` на https://my.telegram.org
4. Создайте бота и получите `BOT_TOKEN` у @BotFather в Telegram
...
- `downloads/` - Подпапка для сохранения результирующих .json файлов
